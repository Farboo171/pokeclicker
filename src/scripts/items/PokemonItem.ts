...
ItemList['Silvally (Water)'] = new PokemonItem('Silvally (Water)', 5000000, Currency.dungeonToken);
ItemList['Silvally (Grass)'] = new PokemonItem('Silvally (Grass)', 5000);
ItemList['Silvally (Fire)'] = new PokemonItem('Silvally (Fire)', 100, Currency.battlePoint); // 100000
ItemList['Silvally (Electric)'] = new PokemonItem('Silvally (Electric)', 100000000, Currency.money);
ItemList['Silvally (Ground)'] = new PokemonItem('Silvally (Ground)', 300, Currency.farmPoint); // 3000000
ItemList['Silvally (Ice)'] = new PokemonItem('Silvally (Ice)', 200, Currency.diamond);
